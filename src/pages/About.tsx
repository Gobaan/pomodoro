  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-16 text-center">
      <div className="max-w-lg w-full flex flex-col items-center gap-8">
        ...
        <button onClick={() => navigate('/')} className="self-start text-slate-400 hover:text-white text-sm transition-colors">← Back</button>

        <div className="flex flex-col items-center gap-3">
          <div className="text-6xl">🎧</div>
          <h1 className="text-4xl font-bold text-white leading-tight">FlowBeats</h1>
        ...
        <div className="w-full bg-white/5 rounded-xl p-5 border border-white/10 text-left">
          ...
          <ol className="list-decimal list-inside space-y-1.5 text-sm text-slate-400">
            <li>Configure your session duration and cycle count in Settings.</li>
